  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route exact path="/popular-movie" component={PopularMovie} />
        <MainPage exact path="/" data={data} genre={genre} currentPage={currentPage} setCurrentPage={setCurrentPage} totalPage={totalPage} />
        <PopularMovie exact path="/popular-movie" dataPopular={dataPopular} genre={genre} currentPage={currentPage} setCurrentPage={setCurrentPage} totalPage={totalPage} />
        {/* <FooterMovie /> */}
      </Switch>
      <div>
